...
# with command line options: TTbar_13TeV_TuneCUETP8M1_cfi --python_filename PhaseI_TTbar_13TeV_NoPu_DynIneff_RECO_cfg.py --fileout file:PhaseI_TTbar_13TeV_NoPu_DynIneff_RECO.root --process PrivateRECO --conditions auto:phase1_2017_realistic --era Run2_2017 --geometry DB:Extended --eventcontent RECOSIM -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --runUnscheduled -n 10 --no_exec
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PhaseI_TTbar_13TeV_NoPu_DynIneff_RECO.root'),
