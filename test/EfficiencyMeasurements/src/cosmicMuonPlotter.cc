...
const std::vector<std::string>    HISTOGRAMS_TO_SAVE_NAMES = {"clusterOccupancy_fwd", "clusterOccupancy_l1", "clusterOccupancy_l2", "clusterOccupancy_l3", "clusterOccupancy_l4", "clusterPhiVsZ_fwd", "clusterPhiVsZ_l1", "clusterPhiVsZ_l2", "clusterPhiVsZ_l3", "clusterPhiVsZ_l4", "clusterGlyVsGlx_barrel", "clusterGlyVsGlx_fwd_disk1", "clusterGlyVsGlx_positiveZ_fwd_disk1", "clusterGlyVsGlx_negativeZ_fwd_disk1", "clusterGlyVsGlx_fwd_disk2", "clusterGlyVsGlx_positiveZ_fwd_disk2", "clusterGlyVsGlx_negativeZ_fwd_disk2", "clusterGlyVsGlx_fwd_disk3", "clusterGlyVsGlx_positiveZ_fwd_disk3", "clusterGlyVsGlx_negativeZ_fwd_disk3", "clusterZ_total", "clusterZ_barrel", "clusterZ_forward", "rechitPhiVsZ_l2", "rechitPhiVsZ_l3", "rechitPhiVsZ_l4", "rechitPhiVsZ_fwd", "rechitOccupancy_l1", "rechitOccupancy_l2", "rechitOccupancy_l3", "rechitOccupancy_l4", "rechitOccupancy_fwd", "sensorEfficiencyWithCutsPhiVsZ_l1", "sensorEfficiencyWithCutsPhiVsZ_l2", "sensorEfficiencyWithCutsPhiVsZ_l3", "sensorEfficiencyWithCutsPhiVsZ_l4", "sensorEfficiencyWithCutsPhiVsZ_fwd", "rocEfficiencyWithCuts_l1", "rocEfficiencyWithCuts_l2", "rocEfficiencyWithCuts_l3", "rocEfficiencyWithCuts_l4", "rocEfficiencyWithCuts_fwd", "cosmicsRingNumhits", "cosmicsRingNumhitsWithAssociatedCluster", "cosmicsRingNumhitsDxyClLessThan1_0", "cosmicsRingEffDxyClLessThan0_5", "cosmicsRingsAverageDx", "cosmicsRingsAverageDy", "cosmicsRowVsColDxyClLessThan0_5_total", "cosmicsRowVsColDxyClLessThan0_5_barrel", "cosmicsRowVsColDxyClLessThan0_5_forward", "rechitGlyVsGlx_barrel", "rechitGlyVsGlx_fwd_disk1", "rechitGlyVsGlx_positiveZ_fwd_disk1", "rechitGlyVsGlx_negativeZ_fwd_disk1", "rechitGlyVsGlx_fwd_disk2", "rechitGlyVsGlx_positiveZ_fwd_disk2", "rechitGlyVsGlx_negativeZ_fwd_disk2", "rechitGlyVsGlx_fwd_disk3", "rechitGlyVsGlx_positiveZ_fwd_disk3", "rechitGlyVsGlx_negativeZ_fwd_disk3", "associatedClusterXDistanceTotal", "associatedClusterYDistanceTotal", "associatedClusterXDistanceBarrel", "associatedClusterYDistanceBarrel", "associatedClusterXDistanceForward", "associatedClusterYDistanceForward", "rechitZ_total", "rechitZ_barrel", "rechitZ_forward", "rechitNormCharge_total", "rechitNormCharge_barrel", "rechitNormCharge_forward"};
