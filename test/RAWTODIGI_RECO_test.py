...
# with command line options: step3 --filein=file:out_step_2.root --fileout=out_step_3.root --step=RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --mc --conditions auto:phase1_2017_realistic --era Run2_2017 --eventcontent FEVTDEBUGHLT --geometry DB:Extended --number=10 --runUnscheduled --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:out_step_2.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('out_step_3.root'),
...
#  Path/Schedule
#---------------------------
process.schedule.remove(process.FEVTDEBUGHLToutput_step)
